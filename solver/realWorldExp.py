...
Commands = [
    ...
    # ["python3", "solver/Main_wally.py", "--exp_name", "scenario_6", "--d", "2"],
    # ["python3", "solver/Main_wally.py", "--exp_name", "scenario_7", "--d", "4"],
    ...
    ["python3", "solver/Main_wally.py", "--exp_name", "scenario_6_np", "--d", "2", "--remove_existing", "--B_length", "10000"],
    ["python3", "solver/Main_wally.py", "--exp_name", "scenario_7_np", "--d", "4", "--remove_existing", "--B_length", "10000"]
]
